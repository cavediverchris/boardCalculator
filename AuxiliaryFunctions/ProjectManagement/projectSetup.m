...
elseif ~verLessThan('matlab','R2019B')
    ...
    % define cache and code gen folders. However R2019B uses a different
    % project API
    ...
    if strcmp(projObj.SimulinkCodeGenFolder, "")
        ...
        projObj.SimulinkCodeGenFolder = strcat(projObj.RootFolder, '\CompiledCode\');
    end
    ...
    if strcmp(projObj.SimulinkCacheFolder, "")
        ...
        projObj.SimulinkCacheFolder = strcat(projObj.RootFolder, '\SimulationRunTimeFiles\');
    end
...
myTemplate = Simulink.exportToTemplate(projObj, 'SimulinkProjectTemplate', ...
                 ...
                 'ThumbnailFile', strcat(projObj.RootFolder, '\AuxiliaryFunctions\ProjectManagement\TemplateThumbnailImage.png'));
